    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex py-0 mt-3">
                <a href="/admin/produk/tambah" class="btn btn-success btn-sm h-100"><i class="fa fa-plus fa-fw"></i> Tambah
                    Produk</a>
                <form action="/admin/swap/produk" method="POST" class="btn-swap ml-3">
                    @csrf
                        ...
                        <tbody>
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td class="align-middle">{{ $product->application_name }}</td>
                                    <td class="align-middle">{{ $product->description }}</td>
                                    <td class="text-center align-middle"><img
                                            src="{{ asset('storage' . $product->filename) }}" style="height: 100px">
                                    </td>
                                    <td class="text-center align-middle" style="white-space: nowrap">
                                        <a href="/admin/produk/{{ $product->id }}" class="btn btn-success btn-sm"><i
